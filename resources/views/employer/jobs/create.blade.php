                    ...
                    <div>
                        ...
                        <div class="flex rounded-md shadow-sm">
                            <select name="salary_currency"
                                ...
                                <option value="EUR" @selected(old('salary_currency') == 'EUR')>EUR</option>
                                <option value="GBP" @selected(old('salary_currency') == 'GBP')>GBP</option>
                            </select>
                    ...
                    <div>
                        ...
                        <select id="salary_period" name="salary_period" required
                            ...
                            @foreach($salaryPeriods as $period)
                                <option value="{{ $period }}" @selected(old('salary_period') == $period)>
                                    {{ ucfirst($period) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select id="work_location_type" name="work_location_type" required
                            ...
                            @foreach($workLocationTypes as $type)
                                <option value="{{ $type }}" @selected(old('work_location_type') == $type)>
                                    {{ ucfirst($type) }}
                                </option>
                            @endforeach
                        </select>
